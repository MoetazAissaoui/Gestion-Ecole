...
public class ModifierFiliere extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModifierFiliere frame = new ModifierFiliere();
	...
	public ModifierFiliere() {
		...
		JLabel lblNewLabel_2 = new JLabel("Modifier Fili\u00E8re");
		...
		lblNewLabel_3.setIcon(new ImageIcon(ModifierFiliere.class.getResource("/img/icons8_administrator_male_40px.png")));
		...
		lblNewLabel_2_1.setIcon(new ImageIcon(ModifierFiliere.class.getResource("/img/icons8-linkedin-20.png")));
		...
		lblNewLabel_2_1_1.setIcon(new ImageIcon(ModifierFiliere.class.getResource("/img/icons8-facebook-20.png")));
		...
		JLabel lblNewLabel_4 = new JLabel("Ancienne Libelle :");
		lblNewLabel_4.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_4.setBounds(10, 11, 124, 26);
		panel_3.add(lblNewLabel_4);
		
		lib = new JTextField();
		lib.setBounds(130, 15, 173, 20);
		panel_3.add(lib);
		lib.setColumns(10);
		...
		panel_4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					st.executeUpdate("update filiere set lib = '"+nvlib.getText().strip().toUpperCase()+"' where lib = '"+lib.getText().strip()+"'");
					JOptionPane.showInternalMessageDialog(null, "Filiere modifiée");
		...
		lblNewLabel_6.setIcon(new ImageIcon(ModifierFiliere.class.getResource("/img/icons8_add_100px_2.png")));
		lblNewLabel_6.setBounds(-13, 0, 97, 58);
		panel_4.add(lblNewLabel_6);
		
		JLabel lblNewLabel_4_1 = new JLabel("Nouvelle Libelle :");
		lblNewLabel_4_1.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_4_1.setBounds(10, 67, 124, 26);
		panel_3.add(lblNewLabel_4_1);
		
		nvlib = new JTextField();
		nvlib.setColumns(10);
		nvlib.setBounds(130, 71, 173, 20);
		panel_3.add(nvlib);
