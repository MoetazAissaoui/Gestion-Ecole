...
public class AfficherNotes extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AfficherNotes frame = new AfficherNotes();
	...
	public AfficherNotes() {
		...
		JLabel lblNewLabel_2 = new JLabel("Afficher Notes");
		...
		lblNewLabel_3.setIcon(new ImageIcon(AfficherNotes.class.getResource("/img/icons8_administrator_male_40px.png")));
		...
		lblNewLabel_2_1.setIcon(new ImageIcon(AfficherNotes.class.getResource("/img/icons8-linkedin-20.png")));
		...
		lblNewLabel_2_1_1.setIcon(new ImageIcon(AfficherNotes.class.getResource("/img/icons8-facebook-20.png")));
		...
		lblNewLabel_6.setIcon(new ImageIcon(AfficherNotes.class.getResource("/img/icons8_add_100px_2.png")));
		...
		panel_4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					String sql="select m.lib , n.note from matiere m , notes n where n.matiere_id = m.idmatiere and cinetudiant = '"+cin.getText()+"';";
					...
					{
						JOptionPane.showInternalMessageDialog(null, "Etudiant non trouvé");
					}
